  ...
  return (
    <S.Container>
      ...
      <S.CardContainer>
        ...
        <S.TextContainer>보호소에서 기다리고 있는 아이들의 새로운 가족이 되어주세요!</S.TextContainer>
        <MainCard
          image={Card1}
          buttonText="보호소 둘러보기"
          link="/animallist"
    ...
    <S.TextContainer>안쓰는 물건을 판매하거나 필요한 물건을 저렴하게 구매해보세요!</S.TextContainer>
        <MainCard
          image={Card3}
    ...
    <S.TextContainer>아이들의 건강을 생각하는 품질 좋은 용품을 구매해보세요<br/>수익금의 일부는 유기 동물 자선단체에 기부됩니다</S.TextContainer>
        <MainCard
