    ...
    <>
      <MyPageNavStyle className="MyPageNav">
        <NavList
          title={"서울특별시"}
          navList={[
            { linkName: "서울특별시", link: ADOPT.ANIMAL_LIST_DETAIL() },
          ]}
        />
        <NavList
          title={"경기도"}
          navList={[{ linkName: "경기도", link: ADOPT.ANIMAL_LIST_DETAIL() }]}
        />
        <NavList
          title={"인천"}
          navList={[
            { linkName: "인천광역시", link: ADOPT.ANIMAL_LIST_DETAIL() },
          ]}
        />
        <NavList
          title={"강원도"}
          navList={[{ linkName: "강원도", link: ADOPT.ANIMAL_LIST_DETAIL() }]}
        />
        <NavList
          title={"충청도"}
          navList={[
            { linkName: "충청북도", link: ADOPT.ANIMAL_LIST_DETAIL() },
            { linkName: "충청남도", link: ADOPT.ANIMAL_LIST_DETAIL() },
            { linkName: "대전광역시", link: ADOPT.ANIMAL_LIST_DETAIL() },
            { linkName: "세종특별자치시", link: ADOPT.ANIMAL_LIST_DETAIL() },
          ]}
        />
        <NavList
          title={"전라도"}
          navList={[
            { linkName: "전라북도", link: ADOPT.ANIMAL_LIST_DETAIL() },
            { linkName: "전라남도", link: ADOPT.ANIMAL_LIST_DETAIL() },
            { linkName: "광주광역시", link: ADOPT.ANIMAL_LIST_DETAIL() },
          ]}
        />
        <NavList
          title={"경상도"}
          navList={[
            { linkName: "경상북도", link: ADOPT.ANIMAL_LIST_DETAIL() },
            { linkName: "경상남도", link: ADOPT.ANIMAL_LIST_DETAIL() },
            { linkName: "울산광역시", link: ADOPT.ANIMAL_LIST_DETAIL() },
            { linkName: "부산광역시", link: ADOPT.ANIMAL_LIST_DETAIL() },
            { linkName: "대구광역시", link: ADOPT.ANIMAL_LIST_DETAIL() },
          ]}
        />
        <NavList
          title={"제주도"}
          navList={[
            { linkName: "제주특별자치도", link: ADOPT.ANIMAL_LIST_DETAIL() },
          ]}
        />
      </MyPageNavStyle>
      <div>
