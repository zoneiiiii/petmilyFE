...
export const MYPAGE = {
  ...
  /**
   ** 활동내역 상세페이지 URL
   ** 사용법: MYPAGE.ORDER_DETAIL(orderNum)
   * @param  orderNum 게시판id
  ...
  QNA: "/mypage/qna",
  /**1:1 문의 세부 페이지 URL
   * @return "/mypage/qna/:id"
   */
  QNA_DETAIL: "/mypage/qna/:id",
  /**1:1 문의 작성 페이지 URL
...
export const ADOPT = {
   ...
   * @return "/adopt/review"
   */
  ADOPT_REVIEW: "/adopt/review",
  /**입양 후기 상세 페이지 URL
   * @return "adopt/review/detail"
   */
  ADOPT_REVIEW_DETAIL: "adopt/review/detail",
  /**입양 후기 작성 페이지 URL
   * @return "/adopt/review/write"
   */
  ADOPT_REVIEW_WRITE: "/adopt/review/write",
  /**입양 신청 페이지 URL
  ...
  /**유기동물 리스트 상세 페이지 URL
   * @return "/adopt/animal/:id"
   */
  ANIMAL_LIST_DETAIL: "/adopt/animal/:id",
};
...
export const SUPPORT = {
  ...
  /**봉사 게시판 상세 페이지 URL
   * @return "/donate/volunteer/notice/:id"
   */
  VOLUNTEER_NOTICE_DETAIL: "/donate/volunteer/notice/:id",
  /**봉사 후기 게시판 페이지 URL
   ...
   */
  VOLUNTEER_REVIEW_DETAIL: "/donate/volunteer/review/:id",
};
...
export const COMMUNITY = {
  ...
  FREE: "/board/free",
  /**자유게시판 상세 페이지 URL
   * @return "/board/free/:id"
   */
  FREE_DETAIL: "/board/free/:id",
  /**자유게시판 작성 페이지 URL
  ...
  FLEA: "/board/flea",
  /**매매장터 상세 페이지 URL
   * @return "/board/flea/:id"
   */
  FLEA_DETAIL: "/board/flea/:id",
  /**매매장터 작성 페이지 URL
   ...
   * @return "board/missing"
   */
  MISSING_DETAIL: "board/missing/:id",
  /**실종 동물 게시판 페이지 URL
