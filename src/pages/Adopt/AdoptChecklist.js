    ...
    <ThemeProvider theme={CustomTheme}>
      ...
      >
        <div>
          ...
          <p>
            아이들이 같은 아픔을 겪지 않게 필수 지식 및 체크리스트를 확인해
            주세요
          </p>
        </div>
        <div
        ...
        >
          ...
          <p>
            1. (결혼 준비중인 경우) 당신의 배우자가 강아지, 고양이 털에
            민감하거나 알러지 반응은 없으신가요?
          </p>
          ...
          <p>
            ...
            약간의 간식, 이전에 쓰던 물품, 장난감, 리드줄, 목욕용품, 빗,
            이동가방
          </p>
          ...
          <br />
          <p>
            그리하여, 가장 기호도가 높고 배변에도 문제 없는 사료를 최종
            선택하시면 됩니다.
          </p>
          ...
          <h4>샤워기의 수압</h4>
          <p id="content">
            ∙ 샤워기의 소리와 센 수압은 반려동물을 겁먹게 할 수 있으므로
            보호자의 손등으로 한번 막아 간접적으로 닿도록 하는 것이 좋습니다.
          </p>
          ...
          <h4>잦은 목욕 금지</h4>
          <p id="content">
            ∙ 너무 잦은 목욕을 시키면 반려동물의 피부 유막을 없애기 때문에
            오히려 피부 자극을 유발합니다.
          </p>
          <p id="content">
            ∙ 건강한 반려견의 경우 3주 ~ 한달에 한번 목욕을 시키는 것이
            좋습니다.
          </p>
          <p id="content">
            ∙ 고양이는 스스로 그루밍을 하여 오염물질을 제거하기 때문에 굳이
            목욕을 시키지 않아도 된다고 권고하는 경우도 있습니다.
          </p>
          <div
            style={{
              display: "flex",
        ...
        <div>
          <CustomButton onClick={onClickBtn} value="체크리스트" label="확인" />
        </div>
      </div>
    </ThemeProvider>
  );
