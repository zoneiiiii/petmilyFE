...
const AdminProductModify = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.put(`/shop/product/update/${boardNum}`, postData, {
  ...
  const handleDelete = () => {
    ...
    if (window.confirm("정말 삭제하시겠습니까?")) {
      try {
        axios.delete(`/shop/product/delete/${boardNum}`);
        navigate(ADMIN.PRODUCT);
