...
const HeaderRight = ({ page }) => {
        ...
        return (
            <HeadrRight className="headright">
                <Stack className="stack" spacing={2} direction="row" >
                    ...
                    <Button onClick={myPageClick} variant="outlined" size="large"
                        sx={{
                            m: 1,
                            color: '#FFFFFF',
                            background: "#FBD385",
    ...
    // 로그아웃 상태일때
        ...
        return (
            <HeadrRight className="headright">
                <Stack className="stack" spacing={2} direction="row" >
                    <Button onClick={joinClick} variant="outlined" size="large"
                        sx={{
                            m: 1,
                            color: "#FFFFFF",
                            background: "#BFBFBF",
                    ...
                    <Button onClick={loginClick} variant="outlined" size="large"
                        sx={{
                            m: 1,
                            color: '#FFFFFF',
                            background: "#FBD385",
